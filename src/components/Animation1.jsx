    ...
    <>
        ...
        <div className='m-auto flex items-center text-center'>
            <div className='basis-2/4  w-full z-[1] text-left p-[0.375rem] '>
                <h2 className='m-0 text-5xl  font-[900]'>Enjoy on your Tv</h2>
                <p className='text-2xl font-normal mt-4 mx-0 mb-0'>Watch on Smart TVs, Playstation, Xbox, Chromecast, Apple TV, Blu-ray players, and more.</p>
            </div>
            <div className='basis-2/4 p-0  z-[1] '>
                <div className='relative'>
                    <img className='w-full' src="./images/animation1tv.png" alt="Kids" />
                </div>
            </div>
        </div>
