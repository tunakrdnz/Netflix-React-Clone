  ...
  return (
    ...
    <div className='m-auto flex items-center text-center'>
        <div className='basis-2/4  w-full z-[1] text-left p-[0.375rem] '>
            ...
            <p className='text-2xl font-normal mt-4 mx-0 mb-0'>Send kids on adventures with their favorite <br /> characters in a space made just for them—free with your membership.</p>
            <div>
                <img src="" alt="" />
                <div></div>
            </div>
